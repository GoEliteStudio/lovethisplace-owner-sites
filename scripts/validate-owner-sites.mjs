...
const completeGallery = JSON.parse(read('src/content/galleries/molonta-owner-preview.en.json'));

assert(registry.includes("slug: 'molonta-owner-preview'"), 'Molonta is registered');
